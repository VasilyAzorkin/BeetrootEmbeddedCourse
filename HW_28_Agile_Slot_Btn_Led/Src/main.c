...
int main(void)
{
  ...
  MX_GPIO_Init();
  /* USER CODE BEGIN 2 */
//  HAL_GPIO_WritePin(BRD_LED_GPIO_Port, BRD_LED_Pin, GPIO_PIN_SET);
  ...
  while (1)
  {
	  HAL_GPIO_WritePin(BRD_LED_GPIO_Port, BRD_LED_Pin, pressed ? GPIO_PIN_RESET : GPIO_PIN_SET);
...
//	  if(!HAL_GPIO_ReadPin(USR_BTN_GPIO_Port, USR_BTN_Pin) && pressed && (HAL_GetTick() - prev) > 80){
//		  pressed = !pressed;
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin : BRD_LED_Pin */
